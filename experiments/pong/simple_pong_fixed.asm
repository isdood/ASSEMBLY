...
; Fixed version with proper terminal handling
...
section .data
    ...
    debug_exit_msg  db 'Exiting Pong game...', 10, 0
    debug_termios_msg db 'Setting up terminal...', 10, 0
    debug_termios_done_msg db 'Terminal setup complete', 10, 0
    debug_ioctl_msg db 'Calling ioctl...', 10, 0
    debug_ioctl_done_msg db 'ioctl completed', 10, 0
    debug_restore_terminal_msg db 'Restoring terminal...', 10, 0
    debug_restore_done_msg db 'Terminal restored', 10, 0
    ...
    ; Game messages
    game_title      db 'SIMPLE PONG - W/S: Left Paddle  Up/Down: Right Paddle  Q: Quit', 10, 0
...
setup_terminal:
    ...
    ; Debug message
    mov rsi, debug_termios_done_msg
    call debug_print
...
restore_terminal:
    ...
    ; Debug message
    mov rsi, debug_restore_terminal_msg
    call debug_print
    ...
    ; Debug message
    mov rsi, debug_restore_done_msg
    call debug_print
